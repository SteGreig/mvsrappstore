      ...
      jQuery.each(data, function (propKey, propValue) {
        if (i < 5) {
          ...
          table_row +=
            ...
            ? parseFloat(propValue["purchaseRevenue"]).toFixed(2)
            : "-") +
            "</td>"; 
          table_row +=
            "<td>" + (propValue["taxAmount"] != undefined
            ? parseFloat(propValue["taxAmount"]).toFixed(2)
            : "-") +
            "</td>";
          table_row +=
            "<td>" + (propValue["refundAmount"] != undefined
            ? parseFloat(propValue["refundAmount"]).toFixed(2)
            : "-") +
            "</td>";
          table_row +=
            "<td>" + (propValue["shippingAmount"] != undefined
            ? parseFloat(propValue["shippingAmount"]).toFixed(2)
            : "-") +
            "</td>";  
          i = i + 1;
        }
