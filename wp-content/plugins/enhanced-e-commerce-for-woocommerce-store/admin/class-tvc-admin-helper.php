...
Class TVC_Admin_Helper{
  ...
  */  
  ...
  function get_conv_pro_link($advance_utm_medium="", $advance_linkclass="tvc-pro", $advance_linktype="anchor", $upgradetopro_text_param="Upgrade to Pro")
  {
    ...
    $upgradetopro_text = esc_html__($upgradetopro_text_param,"enhanced-e-commerce-for-woocommerce-store");
  ...
  {
    $conv_advance_plugin_link = esc_url_raw($this->get_pro_plan_site()."?utm_source=in_app&utm_medium=".$advance_utm_medium."&utm_campaign=".$advance_utm_campaign);
    $conv_advance_plugin_link_return = "";
    $upgradetopro_text = esc_html__($upgradetopro_text_param,"enhanced-e-commerce-for-woocommerce-store");
    if($advance_linktype == "anchor")
    {
