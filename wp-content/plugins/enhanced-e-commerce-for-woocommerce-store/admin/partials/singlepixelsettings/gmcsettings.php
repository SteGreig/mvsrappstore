...
<div class="convcard p-4 mt-0 rounded-3 shadow-sm">
        ...
        <div id="analytics_box_UA" class="py-1">
            ...
            <div class="col-12 flex-row pt-3">
                <div class="col-12 py-2">
                    ...
                    <a id="conv_create_gmc_new_btn" class="" style="cursor:pointer" data-bs-toggle="modal"
                        data-bs-target="#conv_create_gmc_new">
            ...
            <div class="col-12 flex-row pt-3 row">
                <div class="col-5">
                    ...
                    <span class="material-symbols-outlined fs-6" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-container="body"
                        title="When you verify your website, you let Google know that you're the owner of the website. You're the website owner if you have the ability to make edits to your website content. Not the website owner? Work together with your website owner or admin to verify the website.">
                        info
                    </span>
                </div>
                <div class="col-6 site_verifiedDiv">
                    ...
                    <?php } else { ?>
                        <span class="material-symbols-outlined text-danger fs-5 site_verified" onclick="call_site_verified()"
            ...
            <div class="col-12 flex-row pt-3 row domain_claimDiv">
                <div class="col-5">
                    ...
                    <span class="material-symbols-outlined fs-6" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-container="body"
                        title="When you claim your website, it gives you the right to use your website in connection with your Merchant Center account. First you need to verify your website and then you can claim it. Only the user who verified the website can claim it.">
                        info
                    </span>
                </div>
                <div class="col-6">
                    ...
                    <?php } else { ?>
                        <span class="material-symbols-outlined text-danger fs-5 domain_claim" onclick="call_domain_claim()"
                            style="cursor:pointer">
                            sync_problem
                        </span>
                    <?php }
    ...
    <input type="hidden" id="feedType" name="feedType" value="<?php echo isset($_GET['feedType']) && $_GET['feedType'] !='' ? esc_attr($_GET['feedType']) : '' ?>" />
                ...
                <div class="row">
                    <div class="col-7 pe-4">
                        <div id="before_gadsacccreated_text" class="mb-1 fs-6 before-gmc-acc-creation">
                            ...
                            <div class="alert d-flex align-items-cente p-0" role="alert">
                                ...
                                <div
                                    class="p-2 w-100 rounded-end border border-start-0 shadow-sm conv-notification-alert bg-white">
                                    <span>
                    ...
                    <div class="col-5 ps-4 border-start">
                        <div>
                            ...
                            <ul class="p-0">
                                <li><a target="_blank" href="<?php echo esc_url_raw("
            ...
            <div class="modal-footer">
                <div class="me-auto">
                    <button id="create_merchant_account_new"
                        class="btn conv-blue-bg text-white before-gmc-acc-creation me-auto">
                    ...
                    <button type="button" class="ms-3 btn btn-secondary me-auto" data-bs-dismiss="modal"
                        id="model_close_gmc_creation">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-custom">
                            <input class="form-check-input check-height fs-14 errorChannel" type="checkbox"
                                value="<?php //echo esc_html_e($googleDetail->google_merchant_center_id); ?>"
                            ...
                            <label class="col-form-label fs-14 pt-0 fw-400 modal_google_merchant_center_id">
                                <?php //esc_html_e($googleDetail->google_merchant_center_id); ?>
                            </label>
                        </div>
                        <div class="form-check form-check-custom">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-6">
                                <div class="attribute-box mb-3">
                                    ...
                                    <div class="attribute-content para">
                                        ...
                                        <div class="attribute-btn">
                                            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-shopping-feed&tab=feed_list'); ?>" class="btn btn-dark">Manage Feeds</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-6">
                                <div class="attribute-box mb-3">
                                    ...
                                    <div class="attribute-content para">
                                        ...
                                        <div class="attribute-btn">
                                            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-shopping-feed&tab=gaa_config_page'); ?>" class="btn btn-dark">Configure Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>                                          
...
<script>
    ...
    var get_sub = "<?php echo isset($_GET['subscription_id']) && $_GET['subscription_id'] !== '' ? esc_attr($_GET['subscription_id']) : '' ?>"; 
    var gmc_id = "<?php echo $google_merchant_center_id ?>";
    var walk_through = "<?php echo $walk_through_gmc_settings ?>";
    var walk_through_enable = "<?php echo $walk_through_gmc_settings_enable ?>";
    var feed_count = <?php echo $feed_count ?>;
    ...
    function getData($type = "") { 
        var selected_vals = {};
        var walk_through = {};
        walk_through["gmc_settings"] = $type;
        walk_through["gmc_settings_enable"] = "no";
        walk_through["feed_list"] = "<?php echo $walk_through_feed_list ?>";
        walk_through["feed_list_enable"] = "<?php echo $walk_through_feed_list_enable ?>";
        ...
        walk_through["channel_config"] = "<?php echo $walk_through_channel_config ?>";
        walk_through["channel_config_enable"] = "<?php echo $walk_through_channel_config_enable ?>";
    ...
    function walk_tour(type = "") {
        if(type == "") {
            var enjoyhint_instance = new EnjoyHint({
                onStart:function(){
                    jQuery('#tvc_google_signin').css('z-index', '1061');
                },
                onSkip:function(){
            ...
            var enjoyhint_script_steps = [   
                ...
                {
                    "next .tvc_google_signinbtn": 'Click here to link your Google Merchant Center account!',
                    "nextButton" : {className: "myNext", text: "Next"},
                    "skipButton" : {className: "mySkip", text: "Skip"},
                    
                },
                {
                    "next #conv_create_gmc_new_btn": "If you don't have a GMC account, create one, or click Next to select from your existing one!",
                    "nextButton" : {className: "myNext", text: "Next"},
                    "skipButton" : {className: "mySkip", text: "Skip"},  
                },                
                {
                    "click .conv-enable-selection": 'Change your selected Google Merchant Center account!',
                    "nextButton" : {className: "myNext", text: "Next"},
                    "skipButton" : {className: "mySkip", text: "Skip"},
                    "right" : 0,
                    "timeout" : 100,
                    onBeforeStart:function(){                        
                        jQuery('.conv-enable-selection').removeClass('hidden');
                        jQuery('.conv-enable-selection').removeClass('d-none');
                        $(window).scrollTop(5);
                    }
                },
                {
                    "next .select2-container": 'Select your existing Google Merchant Center!',
                    "nextButton" : {className: "myNext", text: "Next"},
                    "skipButton" : {className: "mySkip", text: "Skip"},
                    "timeout" : 100,  
                    onBeforeStart:function(){
                ...
                {
                    "click .conv-btn-connect": 'Save your configuration and start creating your Product Feed!',
                    "nextButton" : {className: "myNext", text: "Next"},
                    "skipButton" : {className: "mySkip", text: "Skip"},  
                    "timeout" : 300,                  
                    onBeforeStart:function(){
            ...
            var enjoyhint_instance = new EnjoyHint({
                onStart:function(){
                    ...
                    jQuery('.enjoyhint').css('z-index', '1060')
                },
                onSkip:function(){
                    getData("skip").then((res) => { });
                },
    ...
    function link_google_Ads_to_merchant_center(link_data, tvc_data, subscription_id) {
        jQuery.ajax({
            ...
            success: function (response) {
                if (response.error === false) {                    
                } else if (response.error == true && response.errors != undefined) { } else {
    ...
    function save_merchant_data(google_merchant_center_id, merchant_id, tvc_data, subscription_id, plan_id, is_skip =
        ...
        if (google_merchant_center_id || is_skip == true) {
            ...
            var website_url = "<?php echo esc_url_raw(site_url()); ?>";
    ...
    <?php if ((isset($_GET['subscription_id']) === TRUE && esc_attr($_GET['subscription_id']) !== '') || (empty($google_merchant_center_id) && !empty($cust_g_email))) { ?>
    ...
    <?php } ?>
            ...
            jQuery(document).on("click", ".conv-btn-connect-enabled-gmc", function () {
                ...
                selected_vals["website_url"] = "<?php echo esc_url_raw(get_site_url()); ?>";
                jQuery.ajax({
                    type: "POST",
                    dataType: "json",
                    url: tvc_ajax_url,
                    ...
                    success: function (response) {                        
                        ...
                        if (response == "0" || response == "1") {
                            ...
                            save_merchant_data(google_merchant_center_id, merchant_id, tvc_data, subscription_id, plan_id, true);
                            if(feedType !== '') {
                                ...
                                if((feed_count == '0' && walk_through == "") || (walk_through == "" && walk_through_enable ==  "yes")){
                                    var enjoyhint_instance = new EnjoyHint({
                                        onStart:function(){
                                        jQuery('.enjoyhint').css('z-index', '1060')
                                        },
                                        onSkip:function(){
                                            jQuery('.enjoyhint').css('z-index', '1010')
                                            getData("skip").then((res) => { });
                                        },
                                        onEnd:function(){
                                            jQuery('.enjoyhint').css('z-index', '1010')
                                    ...
                                    var enjoyhint_script_steps = [
                                        {
                                            "click .createFeed": 'Create Feed to start Syncing your products to your linked Feed channel.',
                                            "nextButton" : {className: "myNext", text: "Next"},
                                            "skipButton" : {className: "mySkip", text: "Skip"},
                                            "top" : 22,
                                            "bottom" : -25,
        ...
        jQuery("#create_merchant_account_new").on("click", function () {
            ...
            if (is_valide == true) {
                var data = {
                    ...
                    country: country,
                    concent: 1,
                    customer_id: "<?php echo $googleDetail->customer_id; ?>",
    ...
    function enable_tutorial(){
        ...
        var selected_vals = {};
        var walk_through = {};
        walk_through["gmc_settings"] = "";
        walk_through["gmc_settings_enable"] = "yes";
        walk_through["feed_list"] = "<?php echo $walk_through_feed_list ?>";
        walk_through["feed_list_enable"] = "<?php echo $walk_through_feed_list_enable ?>";
        walk_through["product_list"] = "<?php echo $walk_through_product_list ?>";
        walk_through["product_list_enable"] = "<?php echo $walk_through_product_list_enable ?>";
