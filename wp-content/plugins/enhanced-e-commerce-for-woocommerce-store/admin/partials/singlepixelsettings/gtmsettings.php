    ...
    <div class="alert d-flex align-items-cente p-0" role="alert">
      ...
      <div class="p-2 w-100 rounded-end border border-start-0 shadow-sm conv-notification-alert bg-white">
        <div class="">
          ...
          <a class="conv-link-blue" target="_blank" href="<?php echo esc_url_raw($TVC_Admin_Helper->get_conv_pro_link_adv("notice", "gtmsettings",  "", "linkonly")); ?>" class="conv_link_blue">
  ...
  <form id="gtmsettings_form">
    ...
    <div class="convpixsetting-inner-box mt-4">
      ...
      <div>
        ...
        <div class="py-1">
          <input type="radio" name="want_to_use_your_gtm" id="want_to_use_your_gtm_own" value="0" readonly disabled>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 text-center">
              <img class="mb-3" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_gtm_logo.png'); ?>">
          ...
          <div class="row mt-5 featureadptboxes">
            <div class="col-md-4 text-center py-3 <?php echo $ga4_id == "" ? "" : "convboxactive"; ?>">
              <div class="convborder p-2 rounded">
                <img class="mb-3 img-32" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_ganalytics_logo.png'); ?>">
                ...
                <?php if ($ga4_id == "") { ?>
                  <a href="<?php echo esc_url_raw("admin.php?page=conversios-google-analytics&subpage=gasettings"); ?>" class="btn w-100 conv-blue-bg text-white btn-lg fs-6">
                ...
                <?php } else { ?>
                  <h4 class="fw-normal fs-6 d-flex justify-content-center pt-2">
                    ...
                    <img class="align-self-center ps-2" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/icon/selected.png"); ?>" />
                  </h4>
                <?php } ?>
              </div>
            </div>
            ...
            <div class="col-md-4 text-center py-3 <?php echo $google_ads_id == "" ? "" : "convboxactive"; ?>">
              <div class="convborder p-2 rounded">
                <img class="mb-3 img-32" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_gads_logo.png'); ?>">
                <h4 class="fw-normal fs-6">
                ...
                <?php if ($google_ads_id == "") { ?>
                  <a href="<?php echo esc_url_raw("admin.php?page=conversios-google-analytics&subpage=gadssettings"); ?>" class="btn w-100 conv-blue-bg text-white btn-lg fs-6">
                    <?php esc_html_e("Connect Now", "enhanced-e-commerce-for-woocommerce-store"); ?>
                  </a>
                <?php } else { ?>
                  <h4 class="fw-normal fs-6 d-flex justify-content-center pt-2">
            ...
            <div class="col-md-4 text-center py-3 <?php echo $fb_pixel_id == "" ? "" : "convboxactive"; ?>">
              <div class="convborder p-2 rounded">
                <img class="mb-3 img-32" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_fb_logo.png'); ?>">
                <h4 class="fw-normal fs-6">
                ...
                <?php if ($fb_pixel_id == "") { ?>
                  <a href="<?php echo esc_url_raw("admin.php?page=conversios-google-analytics&subpage=fbsettings"); ?>" class="btn w-100 conv-blue-bg text-white btn-lg fs-6">
                    <?php esc_html_e("Connect Now", "enhanced-e-commerce-for-woocommerce-store"); ?>
                  </a>
                <?php } else { ?>
                  <h4 class="fw-normal fs-6 d-flex justify-content-center pt-2">
...
<script>
  jQuery(function() {
    ...
    jQuery("#upgradetopro_modal_link").attr("href", '<?php echo esc_url_raw($TVC_Admin_Helper->get_conv_pro_link_adv("popup", "gtmsettings",  "conv-link-blue fw-bold", "linkonly")); ?>');
    // Conversios JS
