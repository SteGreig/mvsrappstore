...
<div class="convcard p-4 mt-0 rounded-3 shadow-sm">
    <form id="advset_customintegration_form" class="convpixsetting-inner-box">
        ...
        <a target="_blank" class="conv-link-blue fw-normal" href="<?php echo esc_url_raw("https://" . TVC_AUTH_CONNECT_URL . "/help-center/event-tracking-custom-integration.pdf"); ?>">
        ...
        <div class="mt-2 d-flex align-items-center">
            ...
            <div class="col-9 d-flex con_dynamic_box">
                ...
                <div class="col-3 px-2">
                    ...
                    <select name="tvc_product_detail_addtocart_selector_type" id="tvc_product_detail_addtocart_selector_type" class="selecttwo conv_enable_inputs_item" style="width: 100%" <?php echo ($tvc_product_detail_addtocart_selector == "default") ? $is_sel_disable : ""; ?>>
                        <?php if (!empty($list)) {
                            foreach ($list as $key => $val) {
            ...
            <div class="col-9 d-flex con_dynamic_box">
                ...
                <div class="col-3 px-2">
                    ...
                    <div id="conv_disable_text" class="<?php echo $tvc_checkout_step_2_selector == "default" ? "conv_disable_text" : ""; ?>">
                        <select name="tvc_checkout_step_2_selector_type" id="tvc_checkout_step_2_selector_type" class="selecttwo conv_enable_inputs_item" style="width: 100%" <?php echo ($tvc_checkout_step_2_selector == "default") ? $is_sel_disable : ""; ?>>
                            <?php if (!empty($list)) {
                                foreach ($list as $key => $val) {
                ...
                <div class="col-6">
                    ...
                    ?>
                    <input type="text" class="form-control conv-text-grey conv_enable_inputs_item" name="tvc_checkout_step_2_selector_val" id="tvc_checkout_step_2_selector_val" value="<?php echo esc_attr($tvc_checkout_step_2_selector_val); ?>" <?php echo ($tvc_checkout_step_2_selector == "default") ? $is_sel_disable : ""; ?>>
                </div>
            </div>
        </div>
        ...
        <div class="mt-2 d-flex align-items-center">
            ...
            <div class="col-9 d-flex con_dynamic_box">
                ...
                <div class="col-3 px-2">
                    ...
                    <select name="tvc_checkout_step_3_selector_type" id="tvc_checkout_step_3_selector_type" class="selecttwo conv_enable_inputs_item" style="width: 100%" <?php echo ($tvc_checkout_step_3_selector == "default") ? $is_sel_disable : ""; ?>>
                        <?php if (!empty($list)) {
                            foreach ($list as $key => $val) {
                ...
                <div class="col-6">
                    ...
                    ?>
                    <input type="text" class="form-control conv-text-grey conv_enable_inputs_item" name="tvc_checkout_step_3_selector_val" id="tvc_checkout_step_3_selector_val" value="<?php echo esc_attr($tvc_checkout_step_3_selector_val); ?>" <?php echo ($tvc_checkout_step_3_selector == "default") ? $is_sel_disable : ""; ?>>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 pb-4 mb-1">
                <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics'); ?>" class="btn conv-blue-bg m-auto text-white">Ok, Done</a>
            </div>
        </div>
    </div>
</div>
