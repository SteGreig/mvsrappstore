...
<div class="convcard p-4 mt-0 rounded-3 shadow-sm">
    ...
    <form id="gadssetings_form" class="convpixsetting-inner-box mt-4">
        <div>
            <!-- Google Ads  -->
            <?php
            $google_ads_id = (isset($googleDetail->google_ads_id) === TRUE && $googleDetail->google_ads_id !== "") ? $googleDetail->google_ads_id : "";
            ?>
            ...
            <div id="checkboxes_box" class="pt-4">
                ...
                <div class="d-flex pt-2 align-items-center">
                    <input class="form-check-input" type="checkbox" value="1" id="google_ads_conversion_tracking" name="google_ads_conversion_tracking" disabled>
                ...
                <div class="d-flex pt-2 align-items-center">
                    ...
                    <input class="form-check-input" type="checkbox" value="1" id="ga_EC" name="ga_EC" disabled>
                ...
                <div class="onbrdpp-body alert alert-primary text-start d-none after-ads-acc-creation" id="new_google_ads_section">
                    ...
                    <ol>
                        <li>
                            ...
                            <em><?php echo (isset($tvc_data['g_mail']) === TRUE) ? esc_attr($tvc_data['g_mail']) : ""; ?></em>
...
<script>
    ...
    function get_conversion_list() {
        ...
        var data = {
            ...
            TVCNonce: "<?php echo esc_attr(wp_create_nonce('con_get_conversion_list-nonce')); ?>"
        };
        jQuery.ajax({
            type: "POST",
            dataType: "json",
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (response) {
                    ...
                    var tvc_data = "<?php echo esc_attr(esc_js(wp_json_encode($tvc_data))); ?>";
    ...
    //Onload functions
    jQuery(function() {
        jQuery("#upgradetopro_modal_link").attr("href", '<?php echo esc_url_raw($TVC_Admin_Helper->get_conv_pro_link_adv("popup", "gadssettings",  "conv-link-blue fw-bold", "linkonly")); ?>');
        ...
        <?php if ( (isset($_GET['subscription_id']) && sanitize_text_field($_GET['subscription_id'])) || ($google_ads_id === "") ) { ?>
            list_google_ads_account(tvc_data);
            jQuery(".conv-enable-selection").addClass("d-none");
        <?php } ?>
        ...
        jQuery(document).on("click", ".conv-btn-connect-enabled-google", function() {
            ...
            selectedoptions["subscription_id"] = "<?php echo esc_attr($tvc_data['subscription_id']) ?>";
