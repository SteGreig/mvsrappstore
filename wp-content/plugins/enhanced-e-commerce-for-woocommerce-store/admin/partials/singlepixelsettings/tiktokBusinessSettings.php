...
<div class="convcard p-4 mt-0 rounded-3 shadow-sm">
    <?php if (isset($pixel_settings_arr[$subpage]['topnoti']) && $pixel_settings_arr[$subpage]['topnoti'] != "") { ?>
        <div class="alert d-flex p-0" role="alert">
            <span class="p-2  pt-3 material-symbols-outlined text-light conv-success-bg rounded-start">info</span>
    ...
    <form id="gmcsetings_form" class="convpixsetting-inner-box mt-4">   
        <div id="" class="py-1">
            ...
            <div class="row pt-2 conv-gmcsettings">
                ...
                <?php $enable = ($tiktok_user_id !== '' ? 'conv-enable-selection': ''); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-4">
                <div class="connected-content">
                    ...
                    <p><span class="fw-bolder">TikTok Business Account -</span> <span
...
<script>
    var walk_through = "<?php echo $walk_through_tiktok_settings ?>";
    var walk_through_enable = "<?php echo $walk_through_tiktok_settings_enable ?>";
    var get_sub = "<?php echo isset($_GET['subscription_id']) && $_GET['subscription_id'] !== '' ? esc_attr($_GET['subscription_id']) : '' ?>"; 
    var tiktok_id = "<?php echo $tiktok_user_id ?>";
    if((tiktok_id == "" && walk_through == "") || (walk_through == "" && walk_through_enable ==  "yes")){
        walk_tour(get_sub)        
    }
    ...
    function getData($type = "") { 
        var selected_vals = {};
        var walk_through = {};
        walk_through["tiktok_settings"] = $type;
        walk_through["tiktok_settings_enable"] = "no";
    ...
    function walk_tour(type = "") {
        if(type == "") {
            ...
            var enjoyhint_script_steps = [   
                ...
                {
                    "next .signIn": 'Click here to link your Tiktok Business Account!',
                ...
                {
                    "click .conv-enable-selection": 'Change your selected Tiktok Business Account!',
                    "nextButton" : {className: "myNext", text: "Next"},
                    "skipButton" : {className: "mySkip", text: "Skip"},
                    "right" : 0,
                    "timeout" : 100,
                ...
                {
                    "next [aria-controls='select2-tiktok_business_id-container']": 'Select your existing Google Merchant Center!',
                    "nextButton" : {className: "myNext", text: "Next"},
                    "skipButton" : {className: "mySkip", text: "Skip"},
                    "timeout" : 100,  
                    onBeforeStart:function(){
    ...
    function save_feed_data() {
        ...
        function enable_tutorial(){
            ...
            var selected_vals = {};
            var walk_through = {};
            walk_through["tiktok_settings"] = "";
            walk_through["tiktok_settings_enable"] = "yes";
            walk_through["gmc_settings"] = "<?php echo $walk_through_gmc_settings ?>";
            walk_through["gmc_settings_enable"] = "<?php echo $walk_through_gmc_settings_enable ?>";
