  ...
  <div class="row justify-content-center">
    ...
    <div class="convfixedcontainermid col-md-8 col-xs-12 m-0 p-0">
      ...
      <div class="convcard d-flex flex-row p-2 mt-0 rounded-3 shadow-sm">
        <div class="convcard-left conv-pixel-logo">
          <div class="convcard-logo text-center p-2 pe-3 border-end">
            <img src="<?php print esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_gtm_logo.png'); ?>" />
          </div>
        </div>
        ...
        <div class="convcard-right ms-auto">
          <a href="<?php print esc_url_raw('admin.php?page=conversios-google-analytics&subpage="gtmsettings"'); ?>" class="h-100 rounded-end d-flex justify-content-center convcard-right-arrow link-dark">
      ...
      <div class="shadow-sm">
        ...
        <div class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-0 border-top <?php echo $conv_gtm_not_connected; ?>">
          <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
            <img class="align-self-center" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_bing_logo.png'); ?>" />
          </div>

          <div class="p-1 ps-3 align-self-center">
            <span class="fw-bold m-0">
              <?php esc_html_e("Microsoft Ads Pixel (Bing)", "enhanced-e-commerce-for-woocommerce-store"); ?>
          ...
          <div class="ms-auto d-flex">
            ...
            <?php } else { ?>
              <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not Connected</span>
            <?php } ?>
            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage="bingsettings"'); ?>" class="rounded-end convcard-right-arrow align-self-center link-dark">
              <span class="material-symbols-outlined p-2">chevron_right</span>
            </a>
          </div>
        </div>
        ...
        <div class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-0 border-top <?php echo $conv_gtm_not_connected; ?>">
          <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
            <img class="align-self-center" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_pint_logo.png'); ?>" />
          </div>
          ...
          <div class="ms-auto d-flex">
            ...
            <?php } else { ?>
              <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not Connected</span>
            <?php } ?>
            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage="pintrestsettings"'); ?>" class="rounded-end convcard-right-arrow align-self-center link-dark">
              <span class="material-symbols-outlined p-2">chevron_right</span>
            </a>
          </div>
        </div>
        ...
        <div class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-0 border-top <?php echo $conv_gtm_not_connected; ?>">
          <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
            <img class="align-self-center" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_twitter_logo.png'); ?>" />
          </div>
          ...
          <div class="ms-auto d-flex">
            ...
            <?php } else { ?>
              <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not Connected</span>
            <?php } ?>
            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage="twittersettings"'); ?>" class="rounded-end convcard-right-arrow align-self-center link-dark">
              <span class="material-symbols-outlined p-2">chevron_right</span>
            </a>
          </div>
        </div>
      ...
      <div class="convcard conv-green-grad-bg rounded-3 d-flex flex-row p-3 mt-4 shadow-sm">
        ...
        <div class="convcard-blue-right align-self-center p-2 bd-highlight mx-auto">
          <img src="<?php print esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/freetopaid_banner_img.png'); ?>" />
        </div>
      </div>
...
<div class="modal fade upgradetosstmodal" id="convSsttoProModal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog ">
    ...
    <div class="modal-content">
      ...
      <h2>
        <?php esc_html_e("Unlock The benefits of", "enhanced-e-commerce-for-woocommerce-store"); ?>
        <br>
        <span>
          <?php esc_html_e("Server Side Tagging Via GTM", "enhanced-e-commerce-for-woocommerce-store"); ?>
        </span>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12 col-12">
          <ul class="listing">
            <span>
              <?php esc_html_e("Benefits", "enhanced-e-commerce-for-woocommerce-store"); ?>
            </span>
        ...
        <div class="col-lg-6 col-md-12 col-12">
          <ul class="listing">
            ...
            <li><?php esc_html_e("Server Side Tagging For Google Analytics 4 (GA4), Google Ads & Facebook CAPI", "enhanced-e-commerce-for-woocommerce-store"); ?></li>
        ...
        <div class="col-12">
          <div class="discount-btn">
            <a target="_blank" href="<?php echo esc_url_raw('https://www.conversios.io/server-side-tagging-gtm/?utm_source=in_app&utm_medium=pixelandanalyticsF&utm_campaign=sstpopup'); ?>" class="btn btn-dark common-btn">Get Early Bird Discount</a>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  let tracking_method = "<?php echo $tracking_method ?>";
  ...
  if (tracking_method != 'gtm' && tracking_method == '') {
    jQuery.ajax({
      ...
      success: function(response) {
        $('.gtm-badge').removeClass('conv-badge-yellow').addClass('conv-badge-green');
        $('.gtm-badge').text('Connected')
        $('.conv-pixel-list-item').removeClass('conv-gtm-not-connected').addClass('conv-gtm-connected')
        $('.gtm-lable').html('Container ID: <b> GTM-K7X94DG (Conversios Default Container)</b>')
      },
      error: function(error) {
        console.log('error', error)
        $('.gtm-badge').removeClass('conv-badge-green').addClass('conv-badge-yellow');
        $('.gtm-badge').text('Mandatory')
        $('.conv-pixel-list-item').removeClass('conv-gtm-connected').addClass('conv-gtm-not-connected')
      }
    });
  }
</script>