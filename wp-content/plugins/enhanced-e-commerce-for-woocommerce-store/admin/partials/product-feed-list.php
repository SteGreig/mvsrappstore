...
<div class="container-fluid conv-light-grey-bg p-4 pb-2">
    ...
    <nav class="navbar navbar-light bg-white shadow-sm" style="border-top-left-radius:8px;border-top-right-radius:8px;">
        <div class="container-fluid">
            ...
            <button class="btn btn-soft-primary create_new_feed" name="create_new_feed" id="create_new_feed">
...
<script>
    ...
    var count_feed = <?php echo $count_feed ?>;
    var walk_through = "<?php echo $walk_through_feed_list ?>";
    var walk_through_enable = "<?php echo $walk_through_feed_list_enable ?>";
    if((count_feed == '0' && walk_through == "") || (walk_through == "" && walk_through_enable ==  "yes")){        
        walk_tours();
    }
    ...
    function getData($type = "") { 
        var selected_vals = {};
        var walk_through = {};
        walk_through["feed_list"] = $type;
        walk_through["feed_list_enable"] = "no";
    ...
    function walk_tours(){
        ...
        var enjoyhint_script_steps = [                        
            {
                "click .create_new_feed": 'Click here to Create Feed and start your Product Feed.',
    ...
    function enable_tutorial(){
        ...
        var selected_vals = {};
        var walk_through = {};
        walk_through["feed_list"] = "";
        walk_through["feed_list_enable"] = "yes";
        walk_through["gmc_settings"] = "<?php echo $walk_through_gmc_settings ?>";
        walk_through["gmc_settings_enable"] = "<?php echo $walk_through_gmc_settings_enable ?>";
        walk_through["product_list"] = "<?php echo $walk_through_product_list ?>";
        walk_through["product_list_enable"] = "<?php echo $walk_through_product_list_enable ?>";
