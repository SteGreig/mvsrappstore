...
$subpage = (isset($_GET["subpage"]) && $_GET["subpage"] != "") ? esc_attr($_GET["subpage"]) : "";
...
if(isset($_GET['subpage']) && $_GET['subpage'] === 'gmcsettings' || isset($_GET['subpage']) && $_GET['subpage'] === 'tiktokBusinessSettings') {
?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4 pb-0">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="fw-normal pt-0">
                                <?php esc_html_e("Upgrade to Pro and Unlock Exclusive Benefits Today!", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </h4>
                            <ul class="conv-upgrade-banner-list ps-4 pt-4">
                                <li>
                                    <?php esc_html_e("Integrate and automate your own GTM with 70+ tags.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </li>
                                <li>
                                    <?php esc_html_e("Maximize campaigns with Google Ads Conversion integration.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </li>
                                <li>
                                    <?php esc_html_e("Quick and Easy Install of Facebook Conversions API.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </li>
                                <li>
                                    <?php esc_html_e("Insightful Ecommerce Reporting Dashboard.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </li>
                                <li>
                                    <?php esc_html_e("Unlimited Product Feed Sync with powerful Content API.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </li>
                                <li>
                        ...
                        <div class="col-md-4 ms-auto">
                            ...
                            <div class="col-12">
                                <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/upgradetopro_popup_img.png'); ?>">
                            </div>
            ...
            <div class="modal-footer border-0 pb-4 mb-1">
                <a id="upgradetopro_modal_link" class="btn conv-yellow-bg m-auto px-5" href="#" target="_blank">
...
<script>
    ...
    jQuery(function() {
        ...
        jQuery(document).on("input",
            "#fb_pixel_id, #microsoft_ads_pixel_id, #twitter_ads_pixel_id, #pinterest_ads_pixel_id, #snapchat_ads_pixel_id, #tiKtok_ads_pixel_id",
            function() {
                var ele_id = this.id;
