               ...
               <div class="column discounted ">
                  ...
                  <div class="tvc-list-price-month">
                    <div class="tvc-list-price">
                      ...
                      <div class="price-current"><span class="inner"><?php printf("%s <span>%s</span>",esc_html_e("$99"),esc_html_e("/year")); ?></span></div>
               ...
               <div class="column discounted ">
                  ...
                  <div class="tvc-list-price-month">
                    <div class="tvc-list-price">
                      ...
                      <div class="price-current"><span class="inner"><?php printf("%s <span>%s</span>",esc_html_e("$199"),esc_html_e("/year")); ?></span></div>
               ...
               <div class="column discounted popular">                
                  ...
                  <div class="tvc-list-price-month">
                    <div class="tvc-list-price">
                      ...
                      <div class="price-current"><span class="inner"><?php printf("%s <span>%s</span>",esc_html_e("$299"),esc_html_e("/year")); ?></span></div>
...
<script>
   $(document).ready(function() {
      jQuery(".column.popular").next().hide();
   })
</script>
<?php
    }
