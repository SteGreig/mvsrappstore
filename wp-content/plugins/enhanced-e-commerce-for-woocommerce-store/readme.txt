...
Plugin Name: Track Google Analytics 4, Facebook Pixel & Conversions API via Google Tag Manager for WooCommerce
Plugin URI: https://wordpress.org/plugins/enhanced-e-commerce-for-woocommerce-store/
Tags: facebook conversions api, google analytics 4, facebook pixel, google tag manager, gtm for woocommerce, gtm, fb pixel, meta pixel, google ads pixel, google ads conversion tracking, google ads dynamic remarketing tags, google analytics for woocommerce, google analytics ecommerce tracking, google analytics tracking, google tag manager for woocommerce, google tag manager datalayer,  fb pixel for woocommerce, snapchat pixel, tiktok pixel, pinterest pixel, microsoft ads pixel, twitter pixel, google shopping automation, google shopping, google analytics integration, google analytics integration for woocommerce, ecommerce tracking, google shopping feed, google analytics plugin, product feed, google analytics reporting, google analytics dashboard, ecommerce datalayer, wordpress dashboard
...
Automate conversions for Google Analytics 4, Google Ads, Facebook Pixel & Conversions API, Snapchat, Pinterest, Tiktok via Google Tag Manager. 

Integrate Facebook Pixel & Facebook Conversions API to help maximise the effectiveness of your Facebook Ads. 

Build dynamic audiences and track sales performance via Google Ads Pixel, Meta (Facebook + Instagram) pixel and Conversions API, Snapchat Pixel, Pinterest Pixel, Tiktok Pixel, Microsoft Ads Pixel and Twitter Pixel to run successful shopping campaigns. 

Seamlessly connect with your Google Merchant Center and Tiktok catalog to automate your WooCommerce Product Feed.

There is no need to do it manually, Product Feed with an API-based structure using powerful tools like Content API and TikTok Ads APIs. Automate your WooCommerce Product Feed to Google Merchant Center and Tiktok Catalog and boost ecommerce sales by product ads campaigns. 

Use our time saving AI powered Super Feed feature to sync Product Feed in just a single click.

== Product Description ==

Track everything with a single plugin and get rid of 10+ plugins from your WooCommerce store in order to make your website faster. Over the last 8+ years and after speaking with thousands of happy customers, we have built rich and useful features to cater to most of your ecommerce marketing needs so that you do not have to rely on multiple plugins for your WooCommerce shops. 

###AN INTERESTING AMALGAM OF GOOGLE ANALYTICS 4, GOOGLE ADS, (META) FACEBOOK PIXEL & FACEBOOK CONVERSIONS API, 6+ AD PIXELS, API based and AI powered Product Feed for Google & Tiktok AND REPORTING DASHBOARD.

== GOOGLE TAG MANAGER, GOOGLE ANALYTICS 4, FACEBOOK PIXEL, SERVER SIDE TAGGING AND MARKETING PIXELS ==

Track everything with a single plugin and remove 10+ plugins from your WooCommerce store to make your website faster. Over the last 8+ years and after speaking with thousands of happy customers, we have built rich and useful features to cater to most of your e-commerce marketing needs so that you do not have to rely on multiple plugins for your WooCommerce shops. 

###Features:

1. Powerful data layer automation of all the ecommerce events and conversions for Google Analytics 4, Google Ads, (Meta) Facebook Pixel & Facebook Conversions API and 6+ Ad pixels
2. Google Tag Manager based implementation for faster page load.
3. Integrate and automate your own Google Tag Manager account with the plugin for full control and for faster page speed. Easy automation of 76 tags, triggers and variables. Quick and Easy Install. No code and no expertise needed. <strong>(<a target="_blank" href="https://www.conversios.io/wordpress/all-in-one-google-analytics-pixels-and-product-feed-manager-for-woocommerce-pricing/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+GTM">Get this pro feature.</a>)</strong>
4. One click <strong>Google Analytics 4 ecommerce tracking</strong> automation. It tracks following events:
   ...
   * All important ecommerce events (along with product and order data) like:
       ...
       * Conversion/order confirmation tracking (Purchase event) <strong>(<a target="_blank" href="https://www.conversios.io/docs/ecommerce-events-that-will-be-automated-using-conversios-2/?utm_source=wp_readme&utm_medium=wplisting&utm_campaign=ga4events">See the detailed guide here.</a>)</strong>
<strong>(<a target="_blank" href="https://youtu.be/KGGI8m_oiaU">See how you can validate Google Analytics 4 tracking on your website.</a>)</strong>
5. Insightful Google Analytics 4 reporting dashboard inside your wordpress admin panel.
6. Google Ads Conversion Tracking & Enhanced Conversion Tracking along with dynamic remarketing pixel.
   * Google Ads Dynamic Remarketing tags for ecommerce events (along with product and order data)
       ...
       * Checkout
       * Purchase
   * Google Ads Conversion Tracking <strong>(<a target="_blank" href="https://www.conversios.io/wordpress/all-in-one-google-analytics-pixels-and-product-feed-manager-for-woocommerce-pricing/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+GACT">Get this feature in premium addon</a>)</strong>
   * Google Ads enhanced Conversion Tracking <strong>(<a target="_blank" href="https://www.conversios.io/wordpress/all-in-one-google-analytics-pixels-and-product-feed-manager-for-woocommerce-pricing/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+GAECT">Available in premium addon</a>)</strong>
7. <strong>Meta pixel (Facebook + Instagram) integration</strong> for ecommerce events (along with product and order data) like:
       * Product detail page view
       * Add to carts
       * Checkout
       * Add payment info
       * Purchase
8. <strong>(Meta) Facebook Conversions API integration</strong> for ecommerce events like:<strong>(<a target="_blank" href="https://www.conversios.io/wordpress/all-in-one-google-analytics-pixels-and-product-feed-manager-for-woocommerce-pricing/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+FBCAPI">Premium Feature</a>)</strong>
       * Product detail page view
       * Add to carts
       * Checkout
       * Purchase
<a target="_blank" href="https://www.conversios.io/docs/how-to-setup-fb-pixel-and-fbcapi-using-conversios-plugin/?utm_source=wp_readme&utm_medium=wplisting&utm_campaign=howtosetupfbcapi">Watch how to setup Facebook pixel and Facebook Conversions API using Conversios plugin.</a>)</strong>
9. <strong>Microsoft Ads pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Page view
       * Product clicks
       * Product detail page view
       * Add to cart
       ...
       * Checkout
       * Purchase
10. <strong>Pinterest pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Product views
       * Checkouts
       * Purchase
11. <strong>Snapchat pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Product view
       * Add to cart
       * Checkout
       * Purchase
       * Page view
12. <strong>Tiktok pixel integration (beta)</strong> for ecommerce events (along with product and order data) like:
       * Product detail page view
       * Add to cart
       * Intiate checkout
       * add payment info
...
13. <strong>Twitter pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Page views
       * Add to cart
       * Checkout
       * Add payment info
       * Purchase
14. <strong>Server side tagging for GA4, Facebook and Google Ads</strong> <a target="_blank" href="https://conversios.io/server-side-tagging-gtm/?utm_source=wp_readme&utm_medium=wplisting&utm_campaign=serversidetagging">Explore more about our end to end server side tagging solution.</a>)</strong>

15. 100% automation of running product ads on Google.


== API BASED & AI POWERED PRODUCT FEED MANAGER FOR GOOGLE SHOPPING AND TIKTOK CATALOG ==

Share your product data from WooCommerce to your Google Merchant Center and get your Store products in front of millions of shoppers across Google. Opt your product data into programs, like surfaces across Google, Shopping ads, Google Free Listing, local inventory ads, and shopping Actions, & highlight your products to shoppers across Google. Reach out to customers leaving your Store by running Smart Google Shopping campaigns based on their past site behavior.

Sync Product Feed to TikTok Catalog and run ads to showcase your products to more than 1 billion users where 50% of the users are between the age group of 24-44.

Improve your product visibility and automate the optimization of your ads using Product Feed to your ads channels. Better visibility using Product Feed will improve conversion rates and increase sales. 

###Features:
1. Product Feed Manager for Google Merchant Center using powerful and real-time content API, no need for XML or CSV Product Feed.
2. Product Feed Manager for Tiktok Catalog using TikTok Ads APIs in a few seconds. <strong> (<a target="_blank" href="https://www.conversios.io/pricing/?utm_source=PFM+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+ProductFeed">Pro</a>) </strong>
...
5. Apply easy but advanced filters to segregate your products from the list of your WooCommerce products and select them for a product feed in channels like Google and Tiktok.
...
8. Get real-time approval status along with error descriptions (for disapproved products) from Google and TikTok for your products.
9. Automate your feed using the Auto-sync feature to keep your product data up-to-date in the feed channels. <strong>(Daily/Weekly) (<a target="_blank" href="https://conversios.io/?utm_source=PFM+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+ProductFeed">Pro</a>)</strong>
10. Product sync that is compatible with 100000+ products.
11. Product Feed Manager for Facebook catalog <strong>(Upcoming)</strong>
12. Product Feed Manager for Snapchat, Pinterest, and Microsoft catalog <strong>(Upcoming)</strong>

== REPORTING, AI POWERED INSIGHTS & CAMPAIGN MANAGEMENT ==

Elevate e-commerce with crucial metrics conversion%, revenue, orders presented through intuitive reports. Google Analytics 4 data is streamlined for actionable insights, enhancing product, channel, and order strategies. Unveil Google Ads performance for empowered campaigns. Scheduled smart emails deliver reports directly to inboxes, streamlining decision-making. AI-driven insights decipher GA4 and Ads data, enriching strategies for maximum conversions and sales growth.

###Features:
1. Insightful & user friendly Google Analytics 4 & Google Ads reporting dashboard inside your wordpress admin panel.
2. AI Powered Insights on your GA4 & Google Ads data to increase sales, conversions and to optimize the marketing ROI.
3. Smart email feature delivers eCommerce reports from GA4 straight into your email inbox daily.
4. Legacy reports like product performance, order performance, channel performance, ecommere funnel and checkout funnel on GA4 data.
5. Create, manage and optimize performance max (product ads) campaign from plugin interface for enhanced ROAS.
