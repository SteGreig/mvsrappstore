...
class Enhanced_Ecommerce_Google_Analytics
{
  ...
  public function tvc_plugin_action_links($links)
  {
    ...
    $setting_url = esc_url_raw('admin.php?page=conversios');
    ...
    $links[] = '<a href="' . esc_url_raw("https://www.conversios.io/docs/how-to-set-up-the-plugin/?utm_source=documentation&utm_medium=pluginlisting&utm_campaign=howtosetup") . '" target="_blank">' . esc_html__("Documentation", "enhanced-e-commerce-for-woocommerce-store") . '</a>';
