    ...
    class Conversios_Dashboard
    {
                                    ...
                                    <div class="commoncard-box sst-card card">
                                        <div class="card-body">
                                            ...
                                            <div class="discount-btn">
                                                <a target="_blank"
                                                    href="<?php echo esc_url_raw('https://www.conversios.io/server-side-tagging-gtm/?utm_source=in_app&utm_medium=dashboardF&utm_campaign=sstbanner'); ?>"
        ...
        public function current_html()
        {
            ...
            ?>
                                                        ...
                                                        <div class="col-xl-8 col-lg-12 col-md-12 col-12 ">
                                                                    ...
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            <div class="purchase-box">
                                                                                ...
                                                                                <div class="form-box">
                                                                                    <input type="email" class="form-control icontrol" readonly
                                                                                        id="exampleFormControlInput1" placeholder="Enter your key">
                                                                                </div>
                                                                                <div class="upgrade-btn">
                                                                                    <a target="_blank"
                                                                                        href="<?php echo $this->TVC_Admin_Helper->get_conv_pro_link_adv("licenceinput", "dashboard", "", "linkonly", ""); ?>"
                                                                                        class="btn btn-dark common-btn">
                                                            ...
                                                            <div class="pixel-setup card">
                                                                <div class="card-body">
                                                                    <div class="feed-box">
                                                                        ...
                                                                        <div class="progress">
                                                                            <div class="progress-bar w-<?php echo $pixelprogressbarclass ?>"
                                                                    ...
                                                                    <div class="pixels-wholebox d-block">
                                                                        <div
                                                                            class="pixel-setup-box pixels-wholebox d-block pt-3  <?php echo $pixel_box_arr['gtmsettings']['active_class'] ?>">
                                                                            <ul class="progress-steps">
                                                                                    ...
                                                                                    <div class="step-box">
                                                                                        <h3 class="px-2 d-flex justify-content-between">
                                                                                            ...
                                                                                            <?php if ($pixel_box_arr['gtmsettings']['active_class'] != '') { ?>
                                                                                                        <span
                                                                                                            class="conv-text-green"><?php esc_html_e("Connected", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                                                                                        </span>
                                                                                            <?php } ?>
                                                                                        </h3>
                                                                                        <p class="p-2">
                                                                                        ...
                                                                                        <?php foreach ($pixel_box_arr as $key => $value) { ?>
                                                                                                    <?php if ($key == 'gtmsettings') { ?>
                                                                                                                <div class="pixels-part col-md-12 px-2 <?php echo $key; ?>">
                                                                                                                    <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage=' . $key); ?>"
                                                                                                                        class="pixels-box w-100 p-2 <?php echo $value['active_class']; ?>">
                                                                                                                        <div class="pixels-image">
                                                                                                                            <img class="align-self-center"
                                                                                                                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . $value['logo']); ?>" />
                                                                                                                        </div>
                                                                                                                        <div class="pixels-text w-100">
                                                                                                                            <h5 class="d-flex lh-base">
                                                                                                                                ...
                                                                                                                                <div class="d-flex justify-content-end w-100">
                                                                                                                                    ...
                                                                                                                                    <span>
                                                                                                                                        <img class="align-self-center"
                                                                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/icon/check_circle_black.svg"); ?>" />
                                                                                                                                    </span>
                                                                                                                                </div>
                                                                                                                            </h5>
                                                                                                                        </div>
                                                                                ...
                                                                                <li
                                                                                    class="<?php echo count($activeClassArr) > 1 ? $pixel_box_arr['gtmsettings']['active_class'] : '' ?>">
                                                                                        ...
                                                                                        <?php foreach ($pixel_box_arr as $key => $value) { ?>
                                                                                                    <?php if ($key != 'gtmsettings') { ?>
                                                                                                                <div class="pixels-part col-md-4 px-2 <?php echo $key; ?>">
                                                                                                                    <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage=' . $key); ?>"
                                                                                                                        class="pixels-box pixel-box-<?php echo $key; ?> w-100 p-2 <?php echo $value['active_class']; ?>">
                                                                                                                        <div class="pixels-image">
                                                                                                                            <img class="align-self-center"
                                                                                                                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . $value['logo']); ?>" />
                                                                                                                        </div>
                                                                                                                            ...
                                                                                                                            <h5 class="d-flex lh-base">
                                                                                                                                ...
                                                                                                                                <div class="d-flex justify-content-end w-100">
                                                                                                                                    ...
                                                                                                                                    <span>
                                                                                                                                        ...
                                                                                                                                        <?php } else { ?>
                                                                                                                                                    <img class="align-self-center"
                                                                                                                                                        src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/icon/add_circle_black.svg"); ?>" />
                                                                        ...
                                                                        <div class="integrate-btn d-flex justify-content-end">
                                                                            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics'); ?>"
                                                                                class="btn btn-dark common-btn">
                                                                    ...
                                                                    <div class="onbrdnpp-cntner acccretppcntnr">
                                                                        <div class="onbrdnpp-hdr">
                                                                            <div class="ppclsbtn clsbtntrgr"><img
                                                                                    src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/close-icon.png'); ?>"
                                                                                    alt="" /></div>
                                                                        </div>
                                                                        <div class="onbrdpp-body">
                                                                                ...
                                                                                <div class="google_connect_url google-btn">
                                                                                    <div class="google-icon-wrapper">
                                                                                        <img class="google-icon"
                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/g-logo.png'); ?>" />
                                                                                    </div>
                                                                                    <p class="btn-text">
                                                                            ...
                                                                            <div style="margin-top: 10px;">
                                                                                <label id="badge_label_check" for="conv_show_badge_onboardingCheck"
                                                                                    class="switch <?php echo empty($this->ee_options['conv_show_badge']) || esc_attr($this->ee_options['conv_show_badge']) == "no" ? "conv_default_cls_disabled" : "conv_default_cls_enabled"; ?>">
                                                                                    <input id="conv_show_badge_onboardingCheck" type="checkbox"
                                                                                        <?php echo empty($this->ee_options['conv_show_badge']) || esc_attr($this->ee_options['conv_show_badge']) == "no" ? "class ='conv_default_cls_disabled'" : "class ='conv_default_cls_enabled' checked"; ?> />
                                                                                    <div></div>
                                                                                </label>
                                                            ...
                                                            <?php if ($this->measurement_id != "" || $this->google_ads_id != "") { ?>
                                                                                                ...
                                                                                                <div class="card-content">
                                                                                                    <div class="smart-powered">
                                                                                                        <a><span> <img
                                                                                                                    ...
                                                                                                                    alt=""
                                                                                                                    class="img-fluid" /></span><?php esc_html_e("Powered Smart Insights", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <div class="genrate-insights">
                                                                                                        <a
                                                                                                            class="btn btn-dark common-btn unlock_ai_insights"><?php esc_html_e("Generate Insights", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                        ...
                                                                        <div class="commoncard-box card ai-poweredcard advanced_ai_sections" <?php echo $ai_cls; ?>>
                                                                            <div class="card-body">
                                                                                <div class="ai-header">
                                                                                    <a><span><img class="align-self-center"
                                                                                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/ai.png'); ?>" /></span><?php esc_html_e("Powered Smart Insights", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                                                                ...
                                                                                <div class="prompttab-box">
                                                                                    ...
                                                                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                                                                        <li class="nav-item" role="presentation">
                                                                                            ...
                                                                                            <button
                                                                                                class="nav-link <?php echo $dstatus_cls01; ?> <?php echo $btn_cls_promptd01; ?>"
                                                                                                id="dash-SourceSales25" data-bs-toggle="pill"
                                                                                                data-bs-target="#dash-prompt-tab1" type="button" role="tab"
                                                                                                aria-controls="pills-home" data-key="SourceSales25"
                                                                                                data-destination="dash_prompt_tab1_ul" data-type="dash"
                                                                                                data-ele_type="button"
                                                                                                aria-selected="true"><?php echo esc_html_e("To increase sales by 25%", "enhanced-e-commerce-for-woocommerce-store"); ?></button>
                                                                                            <?php if ($daysDifferenced01 >= '1') { ?>
                                                                                                        <div id="dash01-refresh-btn" class="refresh-btn ai_prompts"
                                                                                                            data-key="SourceSales25" data-destination="dash_prompt_tab1_ul"
                                                                                                            data-type="dash" data-ele_type="div">
                                                                                                            <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/refresh_ai_white.png'); ?>"
                                                                                        ...
                                                                                        <li class="nav-item" role="presentation">
                                                                                            ...
                                                                                            <button
                                                                                                class="nav-link <?php echo $dstatus_cls02; ?> <?php echo $btn_cls_promptd02; ?>"
                                                                                                id="dash-ProductConv15" data-bs-toggle="pill"
                                                                                                data-bs-target="#dash-prompt-tab2" type="button" role="tab"
                                                                                                aria-controls="pills-profile" data-key="ProductConv15"
                                                                                                data-destination="dash_prompt_tab2_ul" data-type="dash"
                                                                                                data-ele_type="button"
                                                                                                aria-selected="false"><?php esc_html_e("To increase conversions by 15%", "enhanced-e-commerce-for-woocommerce-store"); ?></button>
                                                                                            <?php if ($daysDifferenced02 >= '1') { ?>
                                                                                                        <div id="dash02-refresh-btn" class="refresh-btn ai_prompts"
                                                                                                            data-key="ProductConv15" data-destination="dash_prompt_tab2_ul"
                                                                                                            data-type="dash" data-ele_type="div">
                                                                                                            <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/refresh_ai_white.png'); ?>"
                                                                                                                alt="refresh" class="img-fluid" />
                                                                                                            <div class="tool-tip">
                                                                                        ...
                                                                                        <li class="nav-item" role="presentation">
                                                                                            ...
                                                                                            <button
                                                                                                class="nav-link <?php echo $dstatus_cls03; ?> <?php echo $btn_cls_promptd03; ?>"
                                                                                                id="dash-CampaignPerformImprove" data-bs-toggle="pill"
                                                                                                data-bs-target="#dash-prompt-tab3" type="button" role="tab"
                                                                                                aria-controls="pills-profile" data-key="CampaignPerformImprove"
                                                                                                data-destination="dash_prompt_tab3_ul" data-type="dash"
                                                                                                data-ele_type="button"
                                                                                                aria-selected="false"><?php echo esc_html_e("To improve campaign performance", "enhanced-e-commerce-for-woocommerce-store"); ?></button>
                                                                                            <?php if ($daysDifferenced03 >= '1') { ?>
                                                                                                        <div id="dash03-refresh-btn" class="refresh-btn ai_prompts"
                                                                                                            data-key="CampaignPerformImprove" data-destination="dash_prompt_tab3_ul"
                                                                                                            data-type="dash" data-ele_type="div">
                                                                                                            <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/refresh_ai_white.png'); ?>"
                                                                                                                alt="refresh" class="img-fluid" />
                                                                                                            <div class="tool-tip">
                                                                                    ...
                                                                                    <div class="tab-content" id="dash-pills-tabContent">
                                                                                        <div class="tab-pane fade <?php echo $dstatus_cls_val01; ?>"
                                                                                            id="dash-prompt-tab1" role="tabpanel" aria-labelledby="pills-home-tab"
                                                                                            tabindex="0">
                                                                                        ...
                                                                                        <div class="tab-pane fade <?php echo $dstatus_cls_val02; ?>"
                                                                                            id="dash-prompt-tab2" role="tabpanel" aria-labelledby="pills-profile-tab"
                                                                                            tabindex="0">
                                                                                        ...
                                                                                        <div class="tab-pane fade <?php echo $dstatus_cls_val03; ?>"
                                                                                            id="dash-prompt-tab3" role="tabpanel" aria-labelledby="pills-contact-tab"
                                                                                            tabindex="0">
                                                                                    ...
                                                                                    <div id="dash-robotyping-box" class="robotyping-box" style="display: none;">
                                                                                        <div class="ai-robot">
                                                                                            <video autoplay loop muted height="150" width="150">
                                                                                                <source
                                                                                                    src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/airobot.mp4'); ?>"
                                                                                                    type="video/mp4">
                                                                                            </video>
                                                                                        </div>
                                                                                        <div class="ai-typing">
                                                                                    ...
                                                                                    <div class="view-report">
                                                                                        ...
                                                                                        <a href="<?php echo esc_url_raw('admin.php?page=conversios-analytics-reports'); ?>"
                                                                                            class="link-dark conv-link-blue fw-bold"><?php esc_html_e("Go To Insights & Reporting", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            <div class="feed-wholebox text-center my-5 mb-3">
                                                                                                ...
                                                                                                if (isset($this->ee_options['google_merchant_id']) && $this->ee_options['google_merchant_id'] == '') {
                                                                                                    ...
                                                                                                    ?>
                                                                                                    <button
                                                                                                        style="padding:8px 16px;width: 220px;justify-content: center;align-items: center;gap: 10px;font-size:16px;"
                                                                                                        class="signinWithGoogle btn text-white conv-blue-bg mt-4 btn-lg">
                                                                                                        <?php esc_html_e("Sync Now", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                                                                                    </button>                                                                                                                
                                                                                                <?php } else { ?>
                                                                                                    <button
                                                                                                        style="padding:8px 16px;width: 220px;justify-content: center;align-items: center;gap: 10px;font-size:16px;"
                                                                                                        class="createSuperAIFeed btn text-white conv-blue-bg mt-4 btn-lg">
                                                                                                        <?php esc_html_e("Sync Now", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                                                                                    </button>
                                                                                                <?php } ?>
                                                                                                </span>
                                                                                                ...
                                                                                                <div class="d-flex justify-content-center mt-5" style="margin-left:70px;">
                                                                                                    <img class="align-self-center" style="margin-bottom: 22px;"
                                                                                                        src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/Blue-Tick.svg'); ?>" />
                                                                                    ...
                                                                                    <div class="product-feed card">
                                                                                        <div class="card-body">
                                                                                            <div class="feed-box">
                                                                                                ...
                                                                                                <div class="progress">
                                                                                                    <div class="progress-bar w-<?php echo $progressbarclass ?>" role="progressbar"
                                                                                            ...
                                                                                            <div class="progress-wholebox">
                                                                                                <ul class="progress-steps">
                                                                                                                ...
                                                                                                                <?php foreach ($channel_box_arr as $key => $value) { ?>
                                                                                                                            <div class="channel_part px-2">
                                                                                                                                <a href="<?php echo $value['redirect']; ?>"
                                                                                                                                    class="channel <?php echo $value['active_class']; ?>">
                                                                                                    ...
                                                                                                    <li
                                                                                                        class="<?php echo (is_numeric($is_channel_conected) && !empty($this->ee_prod_mapped_cats) || !empty($this->ee_prod_mapped_attrs)) ? "" : "disable"; ?>">
                                                                                                        <div class="step-box">
                                                                                                            <span class="px-2">
                                                                                                            ...
                                                                                                            <div class="channel-box">
                                                                                                                ...
                                                                                                                ?>
                                                                                                                <div class="channel_part px-2">
                                                                                                                    <a href="admin.php?page=conversios-google-shopping-feed&tab=gaa_config_page"
                                                                                                                        class="channel <?php echo $is_feed_cats_connected == "yes" ? "convo-active" : "convo-inactive" ?>">
                                                                                                                        <div class="channel-image">
                                                                                                                            <?php if ($is_feed_cats_connected == "yes") { ?>
                                                                                                                                        <img class="align-self-center"
                                                                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/Category_Mapping.png'); ?>" />
                                                                                                                            <?php } else { ?>
                                                                                                                                        <img class="align-self-center"
                                                                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/Category_Mapping.png'); ?>" />
                                                                                                                            <?php } ?>
                                                                                                                ...
                                                                                                                <div class="channel_part px-2">
                                                                                                                    <a href="admin.php?page=conversios-google-shopping-feed&tab=gaa_config_page"
                                                                                                                        class="channel <?php echo $is_feed_attr_connected == "yes" ? "convo-active" : "convo-inactive" ?>">
                                                                                                                        <div class="channel-image">
                                                                                                                            <?php if ($is_feed_attr_connected == "yes") { ?>
                                                                                                                                        <img class="align-self-center"
                                                                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/Attribute _mapping.png'); ?>" />
                                                                                                                            <?php } else { ?>
                                                                                                                                        <img class="align-self-center"
                                                                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/Attribute _mapping.png'); ?>" />
                                                                                                                            <?php } ?>
                                                                                                        ...
                                                                                                        <div class="step-box">
                                                                                                            ...
                                                                                                            <?php if ($this->feed_count > 0) { ?>
                                                                                                                        <div class="border border-bottom-0 rounded-top ">
                                                                                                                            <label
                                                                                                                                class="p-2"><?php esc_html_e("Recent Feed List", "enhanced-e-commerce-for-woocommerce-store"); ?></label>
                                                                                                                        </div>
                                                                                                                                    ...
                                                                                                                                    foreach ($this->feed_data as $value) {
                                                                                                                                        ...
                                                                                                                                        ?>
                                                                                                                                                <tr>
                                                                                                                                                        ...
                                                                                                                                                        <?php } else { ?>
                                                                                                                                                                    <span>
                                                                                                                                                                        <a title="Go to feed wise product list"
                                                                                                                                                                            href="<?php echo esc_html(esc_url_raw($feed_wise_url . 'product_list&id=' . $value->id)); ?>"><?php echo esc_html($value->feed_name); ?></a>
                                                                                                                                                                    </span>
                                                                                                                                                        <?php } ?>
                                                                                                                                                    </td>
                                                                                                                                                    <td>
                                                                                                                                                    ...
                                                                                                                                                    <td class="align-middle">
                                                                                                                                                    <?php if ($value->is_delete === '1') { ?>
                                                                                                                                                            <div class="badgebox fs-10 deleted">
                                                                                                                                                                Deleted
                                                                                                                                                            </div>
                                                                                                                                                        <?php } else {
                                                                                                                                                        $draft = 0;
                                        ...
                                        /*********************Card Popover  End**************************************************************************/
                                                                                ...
                                                                                <div class="campaign-wholebox text-center my-5 mb-3 pt-2">
                                                                                    ...
                                                                                    <span class="d-flex justify-content-center">
                                                                                        <a style="padding:8px 24px 8px 24px;" class="btn conv-yellow-bg mt-4 btn-lg"
                                                                                            href="<?php echo esc_url($this->TVC_Admin_Helper->get_conv_pro_link_adv("campaignperformance", "dashboard", "", "linkonly")); ?>"
                                                                                            target="_blank">
                                                                                    ...
                                                                                    <div class="d-flex justify-content-center mt-5">
                                                                                        <img class="align-self-center"
                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/conv-yellow-star-multi.png'); ?>" />
                                                                                        <p class="fs-5 ps-2">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div id="dash-reportnotgenerated" class="report-notgenratedbox d-none">
                                                                                    <div class="card-content">
                                                                                        <div class="card-image">
                                                                                            <img class="align-self-center"
                                                                                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/report_img.svg'); ?>" />
                                                                                        </div>
                                                                                        <div class="card-content">
                                                                                            <h3>
                                                                                ...
                                                                                <div id="dash-reportgenerated" class="genrated-box d-none mb-2">
                                                                                                        ...
                                                                                                        <div class="revenue-box card">
                                                                                                            <div class="card-body">
                                                                                                                ...
                                                                                                                <div class="market-box">
                                                                                                                    <div class="price">-</div>
                                                                                                                    <div class="market">
                                                                                                                        <img class="upmarketimg align-self-center d-none"
                                                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/icon/upmarket.svg'); ?>" />
                                                                                                                        <img class="downmarketimg align-self-center d-none"
                                                                                                                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/red-down.png'); ?>" />
                                                                                                                        <span>-</span>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                    ...
                                                                                    <div class="d-flex justify-content-end pe-2">
                                                                                        <a href="<?php echo esc_url('admin.php?page=conversios-analytics-reports'); ?>"
                                                            ...
                                                            <div class="convcard conv-dash-yellow-bg rounded-3 d-flex flex-row p-3 mt-4 shadow-sm">
                                                                <div class="col-md-8 align-self-center p-2">
                                                                    ...
                                                                    <span class="d-flex">
                                                                        <a style="padding:8px 24px 8px 24px;" class="btn conv-yellow-bg mt-4 btn-lg"
                                                                            href="<?php echo esc_url($this->TVC_Admin_Helper->get_conv_pro_link_adv("yellowbanner", "dashboard", "", "linkonly")); ?>"
                                                                            target="_blank">Upgrade Now</a>
                                                                    </span>
                                                                </div>
                                                                <div class="col-md-4 align-self-center p-2 mx-auto">
                                                                    <img
                                                                        src="<?php print esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/conv-dash-banner-img.png'); ?>" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="convUptoProModal" data-bs-backdrop="static" data-bs-keyboard="false"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer border-0 pb-4 mb-1">
                                                                            <a class="btn conv-yellow-bg m-auto"
                                                                                href="https://www.conversios.io/wordpress/all-in-one-google-analytics-pixels-and-product-feed-manager-for-woocommerce-pricing/?utm_source=in_app&utm_medium=tiktok_banner&utm_campaign=pricing"
                                                                                target="_blank">Upgrade Now</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-xl-4 col-lg-12 col-md-12 col-12">
                                                                ...
                                                                ?>
                                                                        ...
                                                                        <div class="videocard card">
                                                                            <div class="videoimage">
                                                                                <img class="align-self-center"
                                                                                    src="<?php echo esc_url_raw($gettingstarr->thumbnail_url); ?>" />
                                                                            </div>
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="card-content">
                                                                                    ...
                                                                                    <div class="watch-videobtn">
                                                                                        <a target="_blank" href="<?php echo esc_url($gettingstarr->link) ?>"
                                                                                            class="btn btn-dark common-btn">
                                                            ...
                                                            <div class=" card aipowered-card">
                                                                <div class="card-image">
                                                                    <img class="align-self-center animate__animated animate__pulse animate__slower animate__infinite animate__delay-2s"
                                                                        src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/ai-powered.png'); ?>" />
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="get-started">
                                                                        <a href="<?php echo esc_url_raw('admin.php?page=conversios-analytics-reports'); ?>"
                                                                            class="btn btn-dark common-btn"><?php esc_html_e("Get Started", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- SST Box -->
                                                            ...
                                                            <div class="commoncard-box get-premium card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="card-content">
                                                                        <div class="card-image">
                                                                            <img class="align-self-center"
                                                                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/premium.png'); ?>" />
                                                                        </div>
                                                                        <div class=" premium-btn">
                                                                            <a target="_blank"
                                                                                href="<?php echo $this->TVC_Admin_Helper->get_conv_pro_link_adv("sidebar", "dashboard", "", "linkonly", ""); ?>"
                                                                                class="btn btn-dark common-btn">
                                                            ...
                                                            <div class="commoncard-box get-premium need-help card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="card-content">
                                                                        <div class="card-image">
                                                                            <img class="align-self-center"
                                                                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/needhelp.png'); ?>" />
                                                                        </div>
                                                                        <div class="premium-btn book-demo">
                                                                            <a target="_blank"
                                                                                href="<?php echo esc_url_raw("https://calendly.com/d/2mr-9gw-3z5/conversios-product-demo-wordpress"); ?>"
                                                                                class="btn btn-dark common-btn">
                                    ...
                                    <div class="modal fade" id="conv_super_feed_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header justify-content-end connection-header border-0 pb-0">
                                                    <button type="button" style="margin: 0px; padding:0px;" class="btn-close close_feed_modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                                    ...
                                                                    <div class="attribute-box mb-3">
                                                                        ...
                                                                        <div class="attribute-content para">
                                                                            ...
                                                                            <div class="attribute-btn">
                                                                                <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-shopping-feed&tab=feed_list'); ?>"
                                                                                    class="btn btn-dark">Manage Feeds</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-6">
                                                                    <div class="attribute-box mb-3">
                                                                        ...
                                                                        <div class="attribute-content para">
                                                                            ...
                                                                            <div class="attribute-btn">
                                                                                <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-shopping-feed&tab=gaa_config_page'); ?>"
                                                                                    class="btn btn-dark">Configure Now</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <script>
                                        ...
                                        <?php if (is_plugin_active_for_network('woocommerce/woocommerce.php') || in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) { ?>
                                            ...
                                            jQuery(document).on('click', '.createSuperAIFeed', function() {
                                                $('html, body').animate({
                                                    scrollTop: $(".pixel-box-snapchatsettings").offset().top
                                                }, 100);                                                
                                                createSuperAIFeed();
                                            });

                                            function createSuperAIFeed(type) {
                                                jQuery.ajax({
                                                    type: "POST",
                                                    dataType: "json",
                                                    url: tvc_ajax_url,
